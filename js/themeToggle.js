document
	...
	.addEventListener('click', () => {
		...
		if(formField.classList.contains('profile-form-field-light')){
			formField.classList.remove('profile-form-field-light');
			formField.classList.add('profile-form-field-dark');
		}
		else{
			formField.classList.remove('profile-form-field-dark');
			formField.classList.add('profile-form-field-light');
		}
	});
